...
#ifndef NEGLOGSIGMOIDTRANSFORM_H_
#define NEGLOGSIGMOIDTRANSFORM_H_
...
class NegLogSigmoidTransform : public Transform
{
public:
	NegLogSigmoidTransform();
	virtual ~NegLogSigmoidTransform();
...
#endif /*NEGLOGSIGMOIDTRANSFORM_H_*/
